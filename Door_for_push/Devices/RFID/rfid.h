...
#define SET_RC522RST  GPIO_SetBits(GPIOE, GPIO_Pin_1)
#define CLR_RC522RST  GPIO_ResetBits(GPIOE, GPIO_Pin_1)
...
extern unsigned char SN[4]; //���ţ����ֽ���ǰ�����ֽ��ں�
extern unsigned char DATA[16];         //���RFID
extern uint8_t RFID[9];        //ID
extern u8 KEY[6];
extern unsigned char RFID1[16];
extern int8_t Finishflag_RFID;
extern char card0[8];
#endif
